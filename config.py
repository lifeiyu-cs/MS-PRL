...
# common
parser.add_argument('--model_name', default='MSPRL', type=str)
...
parser.add_argument('--train_halftone_path', type=str, default='./dataset/train/data/*.*')
parser.add_argument('--train_target_path', type=str, default='./dataset/train/target/*.*')
parser.add_argument('--valid_halftone_path', type=str, default='./dataset/valid/data/*.*')
...
# Train
parser.add_argument('--total_iters', type=int, default=1)
parser.add_argument('--learning_rate', type=float, default=2e-4)
parser.add_argument('--min_lr', type=float, default=1e-6)
parser.add_argument('--fft_loss_factor', type=float, default=0.1)

# Test
parser.add_argument('--test_model', type=str, default='./checkpoint/MSPRL/MSPRL_300000.pth')
